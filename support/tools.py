...
def get_order_details(order_id):
    try:
        ...
        return{
            ...
            "days_since_order":(timezone.now() - order.created_at).days, # eg - 20 days
        }
...
def get_refund_history(user_id):
    ...
    for refund in refunds:
        history.append({
            ...
            "requested_on": refund.created_at.strftime("%d %b %Y") # eg - 25 May 2026
        }) 
    return{
        "total_refund_history": len(history),
        "history": history,
    }
